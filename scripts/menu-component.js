...
(function (global) {
  ...
  function render(hostEl, items, ctx) {
    ...
    // Tự tạo QR theo size, áp dụng cho 38 -> 46 và cả size mới sau này
    function getSizeQrSrc(neck) {
      const value = String(neck || "").trim();
