// xemhoadon222.js
// Yêu cầu: đã có file supabaseClient.js tạo biến global `supabase` (createClient)
...
(() => {
  ...
  // init date mặc định: tháng hiện tại hoặc theo bạn
