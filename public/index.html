...
<script defer="" src="https://banle-js.vercel.app/caidatbanlevc.js"></script>
<style>
...
<label><input type="checkbox"/> In sau khi lưu</label>
<label><input type="checkbox"/> In không hỏi</label>
